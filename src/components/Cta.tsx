...
export default function Cta() {
  const stats = [
    { value: "500+", label: "Fintech Partners", icon: Building2 },
    { value: "99.99%", label: "API Uptime", icon: Shield },
    { value: "$50B+", label: "Processed Volume", icon: Zap },
    { value: "24/7", label: "Developer Support", icon: Sparkles }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join hundreds of innovative fintech companies using CoreBank Connect's 
                banking infrastructure. Start building in minutes, not months.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by leading fintech innovators and digital banks
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Test all APIs free with unlimited sandbox access
              </p>
            </div>
